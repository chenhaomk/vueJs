        ...
        yhxy : function(){
            ...
            if($("body>.yhxx_popup").length == 0){
                $("body").append('<div class="yhxx_popup popup">\
                                    ...
                                    <div class="content">\
                                        <p>银个购（www.yingegou.com）所提供的各项服务的所有权和运作权均归四川省达观科技有限公司（以下简称“达观”）所有。银个购用户注册协议（以下简称“本协议”）系由银个购用户与达观就银个购的各项服务所订立的相关权利义务规范。因此，请于注册成为银个购会员前，确实详细阅读本协议的所有内容，当用户勾选“已阅读并同意相关“银个购服务协议”并点击注册后，即视为同意本协议的所有条款并愿受其约束，成为银个购会员。</p>\
